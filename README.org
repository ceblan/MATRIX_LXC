...
#+begin_src yaml :tangle (concat (org-entry-get nil "OUT_DIR" t) "create-lxc" (org-entry-get nil "LXC_NAME") ".yml") 
  ---
  - name: Set up LXC container for a EMACS-30
    ...
    tasks:
      ...
      - name: chown git-carlos
        command: lxc-attach -n {{ DEST }} -- chown {{ lxc_username }}:{{ lxc_username }} /home/{{ lxc_username }}/git-carlos
