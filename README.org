...
#+begin_src yaml :tangle ansible/tasks/create-lxc-EMACS-30.yml
  ...
  - name: Set up LXC container for a EMACS-30
    ...
    tasks:
      ...
      - name: create git-carlos
        command: lxc-attach -n {{ DEST }} -- chown {{ emacs_username }}:devpl /home/{{ emacs_username }}/git-carlos
      ...
      - name: Add mount entry to /bar/baz
        lineinfile:
          ...
          line: "lxc.mount.entry = /home/sice/git-sice /home/{{ emacs_username}}/git-carlos none bind 0 0"
